...
public class BeerClientMockTest {
    ...
    void testListBeers() throws JsonProcessingException {
         dtoJson = objectMapper.writeValueAsString(getPage());
    ...
    void getBeerByIdTest()  {
        ...
        mockGetOperation();
        BeerDTO dtoTest=beerClient.getBeerById(dto.getId());
        assertThat(dtoTest.getId()).isEqualTo(dto.getId());
    }
    ...
    void createBeerTest()  {
        ...
        BeerDTO dtoTest=beerClient.createBeer(dto);
        assertThat(dtoTest.getId()).isEqualTo(dto.getId());
    ...
    void testUpdateBeer() {
        ...
        mockGetOperation();
        BeerDTO responseBeerDto=beerClient.updateBeer(dto);
        assertThat(responseBeerDto.getId()).isEqualTo(dto.getId());
    }
    @Test
